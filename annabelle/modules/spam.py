...
@Client.on_message(filters.command("spamstats", prefixes=f"{HANDLER}") & filters.me)
...
@Client.on_message(filters.command("spam", prefixes=f"{HANDLER}") & filters.me)
...
@Client.on_message(filters.command("fastspam", prefixes=f"{HANDLER}") & filters.me)
...
@Client.on_message(filters.command("slowspam", prefixes=f"{HANDLER}") & filters.me)
